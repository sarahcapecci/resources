...
class WPMessenger_List_Draft extends WPMessenger_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            ...
            'plural'    => 'Draft', //plural name of the listed records
...
//        );
    ...
    function process_bulk_action() {        
        ...
        if( 'delete'===$this->current_action() ) {
        	$records_to_delete = $_POST['draft'];//value of $this->_args['singular'] is the "key"
        	...
        	foreach ($records_to_delete as $id){
			    global $wpdb;
				$d = $this->conf->draft;
				$updatedb = "DELETE FROM $d WHERE id='$id'";
    ...
    function prepare_items() {
        ...
        $query =" SELECT * FROM " . $m.                                
                " WHERE user_id=" . $userInfo->ID . " ORDER BY $orderby_column $sort_order";
