...
class WPMessenger_List_Trashed extends WPMessenger_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'Trash', //singular name of the listed records
            'plural'    => 'Trash', //plural name of the listed records
...
//        );
    ...
    function get_sortable_columns() {//Specify which columns will be sortable in the list
        $sortable_columns = array(
            ...
            'guid'  => array('guid',true),
            'received'  => array('received',true)
        );
    ...
    function prepare_items() {
        ...
        $query = "SELECT ".$m.".id, subject,user_id,display_name, received FROM ". $r .
                ...
                " AND ". $r.".label='trash') OR (".$m.".state='deleted' AND ".$m.".user_id = " . 
                $userInfo->ID.")";
